package com.jskierbi.transitionsdemo.transitions;
...
public class RevealTransition extends Visibility {
	...
	@Override public Animator onAppear(ViewGroup sceneRoot,
	                                   final View view,
	...
	@Override public Animator onDisappear(ViewGroup sceneRoot,
	                                      View view,
	                                      TransitionValues startValues,
	                                      TransitionValues endValues) {
		float radius = calculateMaxRadius(view);
	...
	private static class NoPauseAnimatorWrapper extends Animator {
